...
string allUsersSet = "users";
string activeUsersSet = "users:state:active";
string inactiveUsersSet = "users:state:inactive";
string offlineUsersSet = "users:state:offline";
...
bool user6Offline = db.SetContains(offlineUsersSet, "User:6");
...
bool moved = db.SetMove(activeUsersSet, offlineUsersSet, "User:1");
